...
const ContactMe = () => {
  return (
    <div id='contact'>
        <h2 className="text-3xl text-white font-bold text-center  ">Contact Me</h2>
      <StyledWrapper className='flex justify-center py-10'>

        <div className="card">
          <a className="social-link1" href="https://www.instagram.com/i_am_adnan_ali__/">
          ...
          <a className="social-link2" href='https://github.com/imadnanali'>
          ...
          <a className="social-link3" href='https://discord.com/channels/@me' >
          ...
          <a className="social-link4" href='https://www.linkedin.com/in/adnan-ali-8b130b285/'>
          ...
          <a className="social-link5" href='https://wa.me/qr/7NBS5S6MRHODK1'>
